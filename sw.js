const CACHE = 'nutrily-v1'; // bump on every deploy that must invalidate old cached shells
...
self.addEventListener('activate', e => {
  // Delete ALL old caches (nutrily-v0, n6, etc.)
  e.waitUntil(
...
self.addEventListener('fetch', e => {
  ...
  // Gemini API, food data lookups) and non-GET requests must reach the
  // network untouched.
